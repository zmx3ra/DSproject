...
\begin{abstract}
This paper examines the relationship between Ischemic Stroke 30-Day Mortality and 30-Day Readmission Rates, Hospital Quality Ratings, and Location. (More will be added after data description)
\end{abstract}
...
\item Location: quantitative (float), hospital location coordinates.
...
\textbf{Data Dimensions} The size and the shape of the data is 1,026 observations with 9 columns.
